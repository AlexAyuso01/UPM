...
public class Delegaciones {
    ...
    private ArrayList<Delegacion> direccion;
    private ArrayList<Delegacion> negocio;
    ...
    // Class constructor
    public Delegaciones(String delegacion) throws JMSException, InterruptedException {
        this.delegacion = delegacion;
        direccion = new ArrayList<Delegacion>();
        negocio = new ArrayList<Delegacion>();
        try {
            ...
            // Creamos un consumidor y productor JMS
    ...
    public void enviarMensaje(ArrayList<Delegacion> direccion, String equipo) {
        try {
    ...
    public static void main(String[] args) throws JMSException, InterruptedException {
        // crear un objeto delegacion por cada delegacion
        for (String delegacion : delegaciones) {
            // Crear una connection factory
            com.sun.messaging.ConnectionFactory connectionFactory = new com.sun.messaging.ConnectionFactory();
            // Crear una JMS connection
            connection = connectionFactory.createConnection();
            // Crear una JMS session
            session = connection.createSession(false, Session.AUTO_ACKNOWLEDGE);
            // Crear un objeto Delegacion
            System.out.println("creando delegacion"+delegacion);
            new Delegaciones(delegacion);
            // Cerramos 
            connection.close();
            session.close();
        }
